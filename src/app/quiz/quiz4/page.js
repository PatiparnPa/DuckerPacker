  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#FFF7E5] text-center p-6">
      ...
      <div className="space-y-4 w-full max-w-md px-4">
        <button
          onClick={() => handleNextPage('/img/img1')} // Navigate to /img/img1
          className="w-full bg-[#F88F24] text-white px-4 py-3 rounded-md font-bold hover:bg-[#e07f20]"
        >
          ทะเลกว้างสุดลุกหูลุกตา
        </button>
        <button
          onClick={() => handleNextPage('/img/img2')} // Navigate to /img/img2
          className="w-full bg-[#F88F24] text-white px-4 py-3 rounded-md font-bold hover:bg-[#e07f20]"
        >
          ทุ่งดอกไม้ที่ล้อมรอบไปด้วยภูเขาใหญ่
        </button>
        <button
          onClick={() => handleNextPage('/img/img3')} // Navigate to /img/img3
          className="w-full bg-[#F88F24] text-white px-4 py-3 rounded-md font-bold hover:bg-[#e07f20]"
        >
          ท่ามกลางตึกสูงที่เต็มไปด้วยผู้คน
        </button>
        <button
          onClick={() => handleNextPage('/img/img4')} // Navigate to /img/img4
          className="w-full bg-[#F88F24] text-white px-4 py-3 rounded-md font-bold hover:bg-[#e07f20]"
        >
          คาเฟ่สวยๆ และ กาแฟหอมๆ
        </button>
        <button
          onClick={() => handleNextPage('/img/img5')} // Navigate to /img/img5
          className="w-full bg-[#F88F24] text-white px-4 py-3 rounded-md font-bold hover:bg-[#e07f20]"
        >
